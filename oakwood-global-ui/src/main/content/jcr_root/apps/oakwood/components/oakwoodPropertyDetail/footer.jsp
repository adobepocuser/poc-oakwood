...
<div class="footertext">
    ...
    <div style="padding-top: 5px; padding-bottom: 5px">
		 ...
		 <img style="position: relative; top: 3px" src="<%= designer.getDesignPath(currentPage) %>/resources/images.oakwood.com/images/frontPage/icon-eho_logo.gif" height="15" border="0" alt="Equal Housing Opportunity"> Equal Housing Opportunity

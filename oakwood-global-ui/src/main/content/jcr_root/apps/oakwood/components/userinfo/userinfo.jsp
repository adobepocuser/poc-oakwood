...
<nav>
    <ul>
        ...
        %>
        <li class="signout">
            <a href="javascript:logout();" style="color: #FFF; font-weight:normal;"><%= i18n.get("Sign Out") %></a>
        </li>
        <%
        } else {
        ...
        %>
        <li class="login"><a href="<%= xssAPI.getValidHref(loginPagePath) %>.html" style="color: #FFF; font-weight:normal;"><%= i18n.get("Sign In") %></a></li>
        <%
            }

            if (null != signupPagePath) {
        %>
        <li class="signup"><a href="<%= xssAPI.getValidHref(signupPagePath) %>.html" style="color: #FFF; font-weight:normal;"><%= i18n.get("Sign Up") %></a></li>
        <%
                }
            }
        ...
        <%
            if (null != loginPagePath) {
        %>
        <li class="login cq-cc-profile-anonymous"><a href="<%= xssAPI.getValidHref(loginPagePath) %>.html" style="color: #FFF; font-weight:normal;"><%= i18n.get("Sign In") %></a></li>
        <%
            }

            if (null != signupPagePath) {
        %>
        <li class="signup cq-cc-profile-anonymous"><a href="<%= xssAPI.getValidHref(signupPagePath) %>.html" style="color: #FFF; font-weight:normal;"><%= i18n.get("Sign Up") %></a></li>
        <%
                }
            }
        %>
